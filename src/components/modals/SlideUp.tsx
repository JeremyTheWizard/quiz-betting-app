            ...
            <div className='b-w pointer-events-none fixed bottom-0 w-full'>
              ...
              >
                <Dialog.Panel className='pointer-events-auto relative w-full'>
                  ...
                  <div className='flex w-full flex-col overflow-y-scroll rounded-xl bg-white py-6 shadow-xl mobile-l:mx-auto mobile-l:w-[500px]'>
                    <div className='mx-auto mt-2 h-full w-[90vw] mobile-l:w-[450px] '>
                      {children}
                    </div>
                  </div>
                </Dialog.Panel>
